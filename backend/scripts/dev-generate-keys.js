...
console.log('Throwaway dev keypair generated at keys/dev-private.pem and keys/dev-public.pem');
console.log('Set AUTH_PUBLIC_KEY_PATH=./keys/dev-public.pem in .env, then run: npm run dev:mint-token');
