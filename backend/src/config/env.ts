...
const STANDALONE_REQUIRED = ['DEV_ORG_ID', 'DEV_DB_HOST', 'DEV_DB_PORT', 'DEV_DB_NAME'];
...
export function validateEnv(): void {
  ...
  const required = [...ALWAYS_REQUIRED, ...(standalone ? STANDALONE_REQUIRED : LIVE_PLATFORM_REQUIRED)];
